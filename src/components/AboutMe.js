  ...
  return (
    <section name="about" className="about bg-gray-100 dark:bg-black">
      <div className="overflow-hidden md:overflow-visible container flex flex-col dark:bg-black ">
        ...
        <div className="md:flex flex-wrap xl:flex-nowrap text-left items-center ">
          <div className="bg-white drop-shadow-md p-5 mb-5 rounded-md">
            <p className="text-sm">I specialize in creating websites for small to medium and large size businesses. I am here to help you make your brand store professional with the latest web design and UI techniques, to bring your business at the top of the industry.</p>
            <p className="mt-2 text-sm">I have the experience of several web development projects which I personally originated from scratch, plus, several projects of web redesigning in which I not only redesigned the client's website / application but also debugged it.</p>
            <p className="mt-2 text-sm">In my spare time, I enjoy learning new things and exploring with technology. I constantly have to remind myself to keep inspiring myself to go above and beyond.</p>
