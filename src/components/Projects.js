    ...
    <section name="projects" className="bg-gray-100 dark:bg-black">
      <div className="container overflow-hidden flex justify-center items-center">
        <div className="project py-10 flex flex-col items-center justify-center">
          ...
          <div className="projList flex flex-row flex-wrap mx-auto w-full gap-2 p-5">
            {/*Project 1*/}
            <div className="projBox cursor-pointer flex flex-col flex-auto bg-gradient-to-bl from-black to-gray-700 drop-shadow-md p-5 rounded-xl w-full md:w-[300px] h-full">
              <div className="flex flex-col items-center md:items-start object-cover">
                ...
                <img src={Project1} alt="/" className="hover:scale-110 transition ease-in-out duration-700"></img>
            ...
            <div className="projBox cursor-pointer flex flex-col flex-auto bg-gradient-to-bl from-black to-gray-700 drop-shadow-md p-5 rounded-xl w-full md:w-[300px] h-full">
              <div className="flex flex-col items-center md:items-start object-cover">
              <h1 className="text-black p-1 text-sm mb-3 bg-white rounded-md">Portfolio 2</h1>
                <img src={Project} alt="/" className="hover:scale-110 transition ease-in-out duration-700"></img>
                <div className="stacksUse flex w-[30px]">
                  <img src={Reacts} alt="/"></img>
                  <img src={Tailwind} alt="/"></img>
                </div>
            ...
            <div className="projBox cursor-pointer flex flex-col flex-auto bg-gradient-to-bl from-black to-gray-700 drop-shadow-md p-5 rounded-xl w-full md:w-[300px] h-full">
              <div className="flex flex-col items-center md:items-start object-cover">
              <h1 className="text-black p-1 text-sm mb-3 bg-white rounded-md">Portfolio 3</h1>
                <img src={Project} alt="/" className="hover:scale-110 transition ease-in-out duration-700"></img>
                <div className="stacksUse flex w-[30px]">
                  <img src={Reacts} alt="/"></img>
                  <img src={Tailwind} alt="/"></img>
