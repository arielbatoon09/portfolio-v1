...
const Blog = () => {
  return (
    <section name="blog" className="bg-gray-100 dark:bg-black">
      <div className="container flex flex-col dark:bg-black py-10">
        ...
        <div className="flex flex-wrap text-left justify-center items-center gap-5 py-10">
          <div className="bg-white drop-shadow-lg border-gray-200 border rounded-md p-5 w-full md:w-[300px] h-full">
